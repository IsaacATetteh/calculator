...
export default function Home() {
  const whiteButton =
    "flex items-center justify-center w-[83px] h-[50px] bg-[#E9E3DA] rounded-lg shadow-custom font-bold text-[25px]";
  const blueButton =
    "flex items-center justify-center w-[83px] h-[50px] bg-[#A2B2E1] rounded-lg shadow-customblue text-white font-bold text-[20px]";
  return (
    <div className="w-full h-full flex flex-col justify-center items-center bg-[#3B4664] gap-4 ">
      ...
      <div className="w-[440px] h-[435px] rounded-md bg-[#262C45] flex justify-center items-center text-[#414954]">
        <div className="w-[390px] border-2 border-white h-[380px] rounded-md bg-[#262C45] grid grid-cols-4 grid-rows-5 gap-4">
          ...
          <button className="flex items-center justify-center w-[185px] h-[50px] bg-[#A2B2E1] rounded-lg shadow-customblue text-white font-bold text-[20px]">
            RESET
          </button>
          <button className="flex items-center justify-center w-[185px] h-[50px] bg-[#F96C5B] rounded-lg shadow-customblue text-white font-bold text-[20px] col-start-3">
            =
          </button>
        </div>
      </div>
